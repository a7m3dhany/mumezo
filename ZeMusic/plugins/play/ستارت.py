...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/fv_av) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/fv_av) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/fv_av)\n [𝐍𝐈𝐍𝐉𝐀 • 𝐒𝐎𝗨𝐑𝐂𝐄](https://t.me/fv_av)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/fv_av) """,
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/fv_av) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/fv_av) \n ※[These Features AI Based](https://t.me/fv_av)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="fv_av"),
                ...
                [                
                    ...
                    InlineKeyboardButton(" Donate", url=f"https://t.me/fv_av"),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_callback_query(filters.regex("fv_av"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع نينجا من هن : @fv_av **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
